            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <h3 class="col-12 mb-0">{{ __('Edit Auction') }}</h3>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" action="{{ route('auction.update', $data->id) }}" autocomplete="off">
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6  form-group{{ $errors->has('auction_timezone') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-auction_timezone">{{ __('Auction Timezone') }}</label>
                                <input type="text"  value="{{$data->auction_timezone}}"  placeholder="{{ __( 'Select Timezone' ) }}" name="auction_timezone" id="input-auction_end_date" class="form-control  form-control-alternative{{ $errors->has('auction_timezone') ? ' is-invalid' : '' }}">
                           ...
                           {{-- <div class="col-sm-12 form-group{{ $errors->has('buyer_premium') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-12 form-group{{ $errors->has('bidding_increment') ? ' has-danger' : '' }}">
                                <label class="form-control-label" for="input-bidding_increment">{{ __('Minimum Bidding Increment') }}</label>
                                <input type="number" min="0" name="bidding_increment" id="input-bidding_increment" class="form-control form-control-alternative{{ $errors->has('min_bidding_cost') ? ' is-invalid' : '' }}" placeholder="{{ __('Minimum Increment') }}" value="{{ $data->bid_increment }}"  autofocus>
