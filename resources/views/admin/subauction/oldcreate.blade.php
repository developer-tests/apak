                    ...
                    <form method="post" enctype="multipart/form-data" action="{{ route('item.save') }}" autocomplete="off">
                        ...
                        <div class="row">
                           ...
                           {{-- <div class="col-sm-12 form-group{{ $errors->has('buyer_premium') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="buyer_premium"  value="{{old('buyer_premium')}}" id="input-buyer_premium" class="form-control form-control-alternative{{ $errors->has('buyer_premium') ? ' is-invalid' : '' }}"> 
                           ...
                           {{-- <div class="col-sm-12 form-group{{ $errors->has('terms_condition') ? ' has-danger' : '' }}">
                            ...
                            <div class="col-sm-12 form-group{{ $errors->has('bidding_notes') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" name="bidding_notes" id="input-bidding_notes" class="form-control form-control-alternative{{ $errors->has('bidding_notes') ? ' is-invalid' : '' }}" placeholder="{{ __('Bidding Notes') }}" value="{{ old('bidding_notes') }}" >
                                 <input type="hidden" name="parent_id" value="{{$auctionid}}">   
