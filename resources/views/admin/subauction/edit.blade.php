            ...
            <div class="card bg-secondary shadow">
                <div class="card-header bg-white border-0">
                    <div class="row align-items-center">
                        <h3 class="col-12 mb-0">{{ __('Edit Auction Item') }}</h3>
                    </div>
                </div>
                <div class="card-body">
                    <form method="post" enctype="multipart/form-data" action="{{ route('item.update', $data->id) }}" autocomplete="off">
                        ...
                        <a href="{{route('item.index', $data->auctionid)}}" class="btn btn-sm btn-primary">Back</a>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 form-group{{ $errors->has('quantity') ? ' has-danger' : '' }}">
                                ...
                                <input type="number" min="0" name="quantity" id="input-min_bidding_cost" class="form-control form-control-alternative{{ $errors->has('quantity') ? ' is-invalid' : '' }}" placeholder="{{ __('Quantity') }}" value="{{ $data->quantity }}"  autofocus>
