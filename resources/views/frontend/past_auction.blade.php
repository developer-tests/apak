    ...
    <!--- Start Auctions List --->
        ...
        <section class="auctions-list">
            ...
            @foreach($auctions as $auction)       
                    <div class="filter-show auction-past">
                        <div class="city-title">
                        <a href="{{route('catalog', $auction->slug)}}"><p><i class="fa fa-clock-o fa-lg" title="Online-Only Auction">
                        </i>{{$auction->title}} {{date('m/d/Y',strtotime($auction->auction_start_date))}} - {{date('m/d/Y',strtotime($auction->auction_end_date))}}</p></a>
                        </div>
                    ...
                    <div class="col-12 col-sm-12 col-md-7 col-lg-7 col-xl-7 pr-0">
						...
						@endif	
                            ...
                            <div class="city-name-date">
                                <p>City of Miramar Surplus Auction {{date('l, F dS, Y',strtotime($auction->auction_end_date))}}</p>
                            </div>
                        </div>
                    </div>
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                            <div class="catalog-btn">
                                <ul>
                                    <li><i class="fa fa-lock fa-lg"></i><span>Past Auction</span></li>
