                                    ...
                                    <ul>
                                        ...
                                        @auth
                                            @if(userPaymentMethod(\Illuminate\Support\Facades\Auth::id())->count() > 0)
                                                <li>
                                                    <a class="bid_register" href="javascript:(0);" data-toggle="modal"
                                                       data-item-id="0" data-auction-id="{{$auction_detail->id}}"
                                            ...
                                            @else
                                                <li>
                                                    <a href="{{route('payment_method_Check')}}">
                                                        <i class="fa fa-gavel fa-lg"></i>
                                                        <span>Register to Bid</span>
                                                    </a>
                                                </li>
                                ...
                                <div class="wrapper-item">
                                    ...
                                    <div class="center-content">
                                        ...
                                        <script type="text/javascript">
                                            ...
                                            var deadline = '<?php echo date('Y-m-d', strtotime($auction_detail['auction_end_date'])) ?>';
                                                                ...
                                                                <div>
                                                                    <div class="lot-time-label label inline-block label-info">
                                                                        ...
                                                                        <script type="text/javascript">
                                                                            ...
                                                                            var deadline = '{{date('Y-m-d', strtotime($auction_detail['auction_end_date']))}}';
                                                                            initializeClock(idd, deadline);
                                                                        </script>
                                                                    </div>
                                                                </div>
                ...
                <div class="modal-footer text-center">
                    <div class="" style="display:inherit">
                        ...
                        <form action="{{route('entry')}}" method="post">
                            ...
                            <button class="btn btn-primary float-right form-control"  style="margin-left:5px"> Pay Form Wallet
                            </button>
                        </form>
                        @endif
                        <button class="btn btn-primary float-right" style="margin-left:10px" data-toggle="modal" id="add_to_wallet" data-target="#add_wallet_amount_check" data-dismiss="modal"> Ok
                        </button>
                    </div>
                </div>
            </div>
