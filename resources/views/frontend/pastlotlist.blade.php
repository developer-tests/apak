                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="row m-t">
                                                        ...
                                                        <div class="col-sm-8 text-left p-l"
                                                             id="lot-preview-lot-number">{{$item->quantity}}</div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-4 text-right p-r">
                                                            Estimate
                                                ...
                                                <div class="col-8 col-sm-6 col-md-6 col-lg-6 pr-0">
                                                    <div class="row m-x-0">
                                                        ...
                                                        <div class="col-8 pr-0">
                                                            <div><strong><a href=""><b>Lot {{$item->id}}</b>
                                                        ...
                                                        <div class="col-xs-4">
                                                            <div class="lot-price-realized-container">
                                                                <div class="text-center">
                                                                    <strong class="lot-price-realized-title">Price
                                                                        Realized:</strong>
                                                                </div>
                                                                <div class="text-center">
                                                                    <strong class="lot-price-realized">1,25,500.00
                                                                        USD</strong>
                                                                </div>
                                                            </div>
                                                        </div>
                                    ...
                                    <div class="modal-dialog modal-dialog-centered">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8 text-left p-l"
                                                             id="lot-preview-estimate">{{$item->quantity}}</div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-4 text-right p-r">
                                                            Estimate
                                            ...
                                            <div class="modal-footer">
                                                <a id="lot-preview-detail" href="" class="btn btn-default m-x-0"
                                                   target="_blank">Lot Details</a>
                    ...
                    <div class="modal fade" id="myModalgallery{{$item->id}}">
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a id="lot-preview-detail" href="" class="btn btn-default m-x-0" target="_blank">Lot
                                        Details</a>
