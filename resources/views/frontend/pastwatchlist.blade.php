                ...
                <div class="row">
                    <div class="tab-link">
                        <ul>
                            ...
                            <li class="active"><a href="#">My Auctions</a></li>
                    ...
                    <div id="lot-list-buyer-status-top" class="alert alert-info highbid-alert">
                        <div class="row">
                            ...
                            <div class="col-12 col-sm-12 col-md-2 col-lg-2 text-center p-x print-hidden">
                                ...
                                <a id="lot-list-buyer-status-top-watching" href="#" class="btn btn-xs lot-status lot-status-watching" title="Watched Lots"></a>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="m-b change-layout">
                        ...
                        <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                            <div class="text-center-xs lot-list-view-switcher-container">
                                <a href="#" class="print-link btn btn-default" target="_blank"><i class="fa fa-print fa-lg"></i> Print</a>
                            </div>
                        </div>
                        <div class="col-6 col-sm-6 col-md-6 col-lg-6">
                    ...
                    <div class="view-catalog">
                        <div class="row">
                            <div class="col-12 col-sm-12 col-md-8 col-lg-8 col-xl-8">
                                <a href="{{route('catalog',$item->slug)}}"><h4>{{$item->title}}</h4></a>
                                <a href="#"><p>Miami, FL</p></a>
                                <span class="light-font">{{date('Y-m-d',strtotime($item->auction_start_date))}} - {{date('Y-m-d',strtotime($item->auction_end_date))}}</span>
                            </div>
                            <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                <div class="view-catalog-btn">
                                    <a href="{{route('catalog',$item->slug)}}"><i class="fa fa-book fa-lg"></i><span>View Catalog</span></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <!---- Start Condensed Layout --->
                        @foreach ($item->watchlists as $value)
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                    <div class="label-info padding-top">
                                                        <span class="text-wrap">{{getBidTime($item->auction_start_date,$item->auction_end_date)}}  </span>
                                                ...
                                                <div class="col-12 col-sm-12 col-md-4 col-lg-4 col-xl-4">
                                                    <div class="high-bid">
                                                        <span>High Bid</span>
                                                        <div class="lot-high-bid">{{$value->bidds->max('amount')?$value->bidds->max('amount'):0}} USD </div>
                                                    </div>  
                                                </div>
                                                <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="bid-status-watching">
                                                        <h4><span class="label  lot-status lot-status-watching">Watching</span></h4>
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="space-brtween">
                                                        @auth
                                                        <button class="lowrb-trigger btn p-x btn-primary openBidModal" title="Bid" type="button" id="{{$value->id}}"><i class="fa fa-plus fa-lg" title="Bid"></i>
                                                        @endauth
                                                        @guest    
                                                        <button class="lowrb-trigger btn p-x btn-primary" title="Bid" type="button" data-toggle="modal" data-target="#loginRegisterModal"><i class="fa fa-plus fa-lg" title="Bid"></i>
                                                        @endguest
                                                        </button>
                                                        <button class="watch-lot lowrb-trigger unwatch-lot watch-notes-popover-trigger btn btn-default p-x unwatchItem" type="button" title="" data-itid="{{$value->id}}" data-aucid="{{$item->id}}">	<i class="fa fa-times fa-lg" title="Unwatch"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
