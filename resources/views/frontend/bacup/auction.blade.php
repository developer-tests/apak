                                        ...
                                        <div class="col-12">
                                            <div class="three-btn">
                                                <ul>
                                                    ...
                                                    @endguest
                                                    <li><a href="{{route('catalog', $auction_detail[0]['slug'])}}"><i class="fa fa-book fa-lg"></i> <span>View Catalog	<strong class="hidden-xs hidden-sm">({{$auction_items}} Lots)</strong>
                                                    </span></a></li>
                                                </ul>
                                            </div>
                                        </div>
                          ...
                          <div class="card">
                            ...
                            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
                              ...
                              <div class="card-body">
                                    ...
                                    <td class="col-sm-8 col-md-9 col-lg-10">{{$auction_detail[0]['title']}} {{date("m/d/Y", strtotime($auction_detail[0]['auction_start_date']))}} - {{date("m/d/Y", strtotime($auction_detail[0]['auction_end_date']))}}</td>
                                    </tr>
                                     @if(count($seller) > 0)  
                                    <tr>
                                    ...
                                    <td class="col-sm-8 col-md-9 col-lg-10">{{$auction_detail[0]['auction_type']}} Auction</td>
                                    </tr>

                                    <tr>
                                    <th class="col-sm-4 col-md-3 col-lg-2 text-right">Date(s)</th>

                                    <td class="col-sm-8 col-md-9 col-lg-10"> {{date("m/d/Y", strtotime($auction_detail[0]['auction_start_date']))}} - {{date("m/d/Y", strtotime($auction_detail[0]['auction_end_date']))}}</td>
                                    </tr>

                                    <tr>
                                    <th class="col-sm-4 col-md-3 col-lg-2 text-right"></th>

                                    <td class="col-sm-8 col-md-9 col-lg-10">{{$auction_detail[0]['auction_type']}} Auction! 
                                   
                                    Starts: {{date("l, F dS, Y", strtotime($auction_detail[0]['auction_start_date']))}} @ {{$auction_detail[0]['auction_timezone']}}
                                    Ends: {{date("l, F dS, Y", strtotime($auction_detail[0]['auction_end_date']))}} @ {{$auction_detail[0]['auction_timezone']}}</td>
                                    </tr>

                                    <tr>
                                    <th class="col-sm-4 col-md-3 col-lg-2 text-right">Preview Date/Time</th>

                                    <td class="col-sm-8 col-md-9 col-lg-10">{{$auction_detail[0]['preview_date_time']}}</td>
                                    </tr>

                                    <tr>
                                    <th class="col-sm-4 col-md-3 col-lg-2 text-right">Checkout Date/Time</th>

                                    <td class="col-sm-8 col-md-9 col-lg-10">{{$auction_detail[0]['checkout_date_time']}}</td>
                                    </tr>
                                   ...
                                   {{$seller[0]->address_2}}</a>
                                    ...
                                    <td class="col-sm-8 col-md-9 col-lg-10">
                                    <div class="text-pre-line">{!!$auction_detail[0]['description']!!}</div>
                                    </td>
                                    </tr>
                        ...
                        <div class="card">
                            ...
                            <!-- Card header -->
                                ...
                                <div id="collapseFive5" class="collapse" role="tabpanel" aria-labelledby="headingFive5"
                                    data-parent="#accordionEx">
                                    <div class="card-body">
                                        {{$auction_detail[0]['shipping_pickup']}}
                                    </div>
                                </div>
