      ...
      <div class="row">
         <div class="grid-box-main">
            ...
            <div class="wrapper-item">
               ...
               <div class="center-content">
				  <div class="bid-status bid-status-76282044" data-event-item-id="0" data-status="nobid">
					   ...
					   <div class="bid-status-winning  hidden">
						  <h4>            <span class="label  lot-status inline-block text-wrap lot-status-default">Winning</span></h4>
					   </div>
					   <div class="bid-status-won  hidden">
						  <h4>            <span class="label  lot-status inline-block text-wrap lot-status-default">Won</span></h4>
					   </div>
					   ...
					   <div class="bid-status-mayhavewon  hidden">
						  <h4>            <span class="label  lot-status inline-block text-wrap lot-status-default">May Have Won</span></h4>
					   </div>
					   <div class="bid-status-pending  hidden">
						  <h4>            <span class="label  lot-status inline-block text-wrap lot-status-default">Pending</span></h4>
					   </div>
					   <div class="bid-status-notaccepted  hidden">
						  <h4>            <span class="label  lot-status inline-block text-wrap lot-status-default">Not Accepted</span></h4>
					   </div>
					   <div class="bid-status-sealed  hidden">
						  <h4>            <span class="label  lot-status inline-block text-wrap lot-status-default">Sealed</span></h4>
					   </div>
					   <div class="bid-status-passed  hidden">
						  <h4>            <span class="label  lot-status inline-block text-wrap lot-status-default">Pass</span></h4>
					   </div>
					   <div class="bid-status-outbid  hidden">
						  <h4>            <span class="label  lot-status inline-block text-wrap lot-status-default">Outbid</span></h4>
					   </div>
					   <div class="bid-status-declined  hidden">
						  <h4>            <span class="label  lot-status inline-block text-wrap lot-status-default">Declined</span></h4>
					   </div>
					   <div class="bid-status-watching  hidden">
						  <h4>    <span class="label  lot-status lot-status-default">Watching</span></h4>
					   </div>
					</div>
                  <span class="lot-high-bid text-bold" >{{number_format($item->min_bidding_cost,2)}} USD </span>
                  <div class="lot-bid-history"><a href="javascript:void(0)" data-toggle="modal" data-target="#bidHistory"><span>21 Bids</span></a></div>
               ...
               <button class="lowrb-trigger lot-bid-button lot-bid-button-bid-amount btn btn-primary btn-block print-hidden" type="button" data-toggle="modal" data-target="#registerForBidModal"><span>Bid</span> {{number_format($item->min_bidding_cost, 2)}}</button>
                  <button type="button" class="btn btn-primary watch_item" data-itid="{{$item->id}}" data-aucid="{{$item->auctionid}}">
                  <i class="fa fa-star fa-lg"></i></button>
				  <div class="lot-unwatch-container bid-watch-btn tile-watch-unwatch text-right pull-right m-l-xs p-1 unwatch_item hidden" data-itid="{{$item->id}}" data-aucid="{{$item->auctionid}}">
               ...
               <div class="modal-dialog modal-dialog-centered">
                  <div class="modal-content">
                        ...
                        <div class="col-12">
                           ...
                           <div id="lot-preview-bid-history-container" class="row">
                              ...
                              <div class="col-sm-8 text-left p-l">
                                 <a class="lot-bid-history  btn btn-link p-a-0" href="javscript:void(0)" data-toggle="modal" data-target="#bidHistory" >20 Bids</a>
                              </div>
                           </div>
                           <div class="row">
                              <div class="col-sm-4 text-right p-r">
                     ...
                     <div class="modal-footer">
                        ...
                        <a id="lot-preview-contact" class="btn btn-success lot-feedback m-x-0" href="javascript:(0);" data-toggle="modal" data-target="#contactSeller">
                              ...
                              <div class="col-sm-6 p-0 hidden-xs">
                                 <div class="row m-x-0">
                                    <div class="text-center col-2">
                                       <a class="lot-bid-history  btn btn-link p-a-0" href="jaavscript:void(0);" data-toggle="modal" data-target="#bidHistory">20 Bids</a>
                                    </div>
                                    <div class="col-3">
                                    ...
                                    <div class="col-4">
                                       <div id="lot-at-banner" class="at-banner hidden">
                                          <img src="/Styles/images/icons/at-icon.png" alt="Auction Time">
                                          Online Auction
                                       </div>
                                       <div id="lot-ef-banner" class="ef-banner hidden">
                                          <img src="/Styles/images/icons/ef-icon.png" alt="EquipmentFacts">
                                          On-Site Auction
                                       </div>
                                    </div>
                                    <div class="col-3">
                                 ...
                                 <div class="row m-x-0">
                                    <div class="col-3 col-sm-3 col-md-3 col-lg-3 p-0 inline-lot-bid-button-container print-hidden">
                                       ...
                                       <div class="lot-bid-container inline-lot-bid-container text-center">
                                          <button class="lowrb-trigger btn p-x btn-primary" title="Bid" type="button" id="lot-bid-button-76282044" >  <i class="fa fa-plus fa-lg" title="Bid"></i>
                                          </button>
                                       </div>
                                    </div>
                                    <div class="col-3 col-sm-3 col-md-3 col-lg-3 p-0 lot-inline-altbid-button-container text-center">
                                       <a class="btn p-x btn-primary hidden" id="lot-inline-altbid-button" href="">
					   ...
					   <div class="bid-status-watching  hidden">
						  <h4>    <span class="label  lot-status lot-status-default">Watching</span></h4>
                                    ...
                                    <div class="col-3 col-sm-3 col-md-3 col-lg-3 p-0 inline-lot-watch-button-container print-hidden">
                                          ...
                                          <button type="button" class="watch-lot lowrb-trigger watch-notes-popover-trigger btn btn-default p-x watch_item" data-itid="{{$item->id}}" data-aucid="{{$item->auctionid}}">
										  <i class="fa fa-star fa-lg" title="Watch"></i>
                                          </button>
                                      
                                       <div class="lot-unwatch-container text-center unwatch_item hidden"  data-itid="{{$item->id}}" data-aucid="{{$item->auctionid}}">
               ...
               <div class="row">
                  ...
                  <div class="col-12 col-sm-12 col-md-3 col-lg-3 col-xl-3">
                     ...
                     <div class="inline-btn">
                        <button class="watch-lot lowrb-trigger watch_item watch-notes-popover-trigger btn btn-default btn-block print-hidden" type="button" data-itid="{{$item->id}}" data-aucid="{{$item->auctionid}}">
                        <i class="fa fa-star fa-lg"></i>
                        <span class="hidden-xs">Watch</span>
                        </button>
                       <button type="button" class="unwatch_item watch-lot lowrb-trigger watch_item watch-notes-popover-trigger btn btn-default btn-block print-hidden hidden"  data-itid="{{$item->id}}" data-aucid="{{$item->auctionid}}">
                            <i class="fa fa-times fa-lg" title="Unwatch"></i>
                            <span class="hidden-xs">Unwatch</span>
                        </button>
         ...
         <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
               ...
               <div class="modal-footer">
                  ...
                  <button class="watch-lot lowrb-trigger unwatch-lot watch-notes-popover-trigger btn btn-default print-hidden m-x-0 hidden" data-ba="10" type="button" data-bai="76282044" id="lot-unwatch-button-76282044" data-original-title="" title="">  <i class="fa fa-times fa-lg"></i>
                  <span class="hidden-xs">Unwatch</span>
                  </button>
                  <a id="lot-preview-contact" class="btn btn-success lot-feedback m-x-0" href="javascript:(0);" data-toggle="modal" data-target="#contactSeller">
                  <i class="fa fa-envelope fa-lg"></i>
