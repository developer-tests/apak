    ...
    <div class="modal fade" id="registerForBidModalCheck" tabindex="-1"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>You need to add 100 amount in your wallet to Register Bid on current Auction</p>
                    <p>Please click Ok to process</p>
                </div>
                <div class="modal-footer text-center">
                    <div class="col-md-3 col-6 mx-auto">
                        <button class="btn btn-primary float-right" data-toggle="modal" id="add_to_wallet" data-target="#add_wallet_amount_check" data-dismiss="modal"> Ok
                        </button>
                    </div>
                </div>
            </div>
